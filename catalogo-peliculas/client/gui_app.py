...
class Frame(tk.Frame):
    ...
    def campos_peliculas(self):
        ...
        self.boton_guardar = tk.Button(
            self, text="Guardar", command=self.guardar_pelicula
        )
    ...
    def guardar_pelicula(self):
        self.movie = Movie(
            self.mi_nombre.get(), self.mi_duracion.get(), self.mi_genero.get()
        )
    ...
    def tabla_peliculas(self):
        ...
        for movie in self.movies:
            self.tabla.insert(
                "", 0, text=movie[0], values=(movie[1], movie[2], movie[3])
            )
        ...
        self.boton_eliminar = tk.Button(
            self, text="Eliminar", command=self.eliminar_pelicula
        )
    ...
    def editar_pelicula(self):
        try:
            ...
            self.name_movie = self.tabla.item(self.tabla.selection())["values"][0]
            self.duration_movie = self.tabla.item(self.tabla.selection())["values"][1]
            self.gender_movie = self.tabla.item(self.tabla.selection())["values"][2]
