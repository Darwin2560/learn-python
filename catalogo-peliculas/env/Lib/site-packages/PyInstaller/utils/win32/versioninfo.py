...
class FixedFileInfo:
    ...
    def __str__(self, indent=""):
        fv = (
            self.fileVersionMS >> 16,
            self.fileVersionMS & 0xFFFF,
            self.fileVersionLS >> 16,
            self.fileVersionLS & 0xFFFF,
        )  # yapf: disable
        pv = (
            self.productVersionMS >> 16,
            self.productVersionMS & 0xFFFF,
            self.productVersionLS >> 16,
...
class StringFileInfo:
    ...
    def toRaw(self):
        ...
        return (
            struct.pack("hhh", sublen, vallen, typ) + raw_name + b"\000\000" + pad + tmp
        )
...
class VarStruct:
    ...
    def fromRaw(self, data, i, limit):
        i, (self.sublen, self.wValueLength, self.wType, self.name) = parseCommon(
            data, i
        )
        i = nextDWord(i)
