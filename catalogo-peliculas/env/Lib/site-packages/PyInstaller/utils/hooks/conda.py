...
class Distribution:
    ...
    def from_name(cls, name: str):
        ...
        raise ModuleNotFoundError(
            "Distribution {} is either not installed or was not installed using Conda.".format(
                name
            )
        )
    ...
    def from_package_name(cls, name: str):
        ...
        raise ModuleNotFoundError(
            "Package {} is either not installed or was not installed using Conda.".format(
                name
            )
        )
...
def walk_dependency_tree(initial: str, excludes: Iterable[str] | None = None):
    ...
    while names_to_do:
        ...
        try:
            ...
            logger.debug(
                "Collected Conda distribution '%s', a dependency of '%s'.",
                name,
                initial,
            )
...
def files(
    name: str, dependencies: bool = False, excludes: list | None = None
) -> List[PackagePath]:
    """
