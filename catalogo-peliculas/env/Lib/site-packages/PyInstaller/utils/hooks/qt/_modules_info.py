...
class _QtModuleDef:
    def __init__(
        self, module, shared_lib=None, translations=None, plugins=None, bindings=None
    ):
...
QT_MODULES_INFO = (
    ...
    _QtModuleDef(
        "QtOpenGLWidgets", shared_lib="OpenGLWidgets", bindings=["PySide6", "PyQt6"]
    ),
    ...
    # *** qt/qtconnectivity ***
    _QtModuleDef(
        "QtBluetooth", shared_lib="QtBluetooth", translations=["qtconnectivity"]
    ),
    ...
    _QtModuleDef(
        "QtSpatialAudio", shared_lib="SpatialAudio", bindings=["PySide6", "PyQt6"]
    ),
    # *** qt/qtnetworkauth ***
    ...
    _QtModuleDef(
        "QtScxml", shared_lib="Scxml", plugins=["scxmldatamodel"], bindings=["PySide6"]
    ),
    ...
    # *** qt/qtsensors ***
    _QtModuleDef(
        "QtSensors", shared_lib="Sensors", plugins=["sensors", "sensorgestures"]
    ),
    # *** qt/qtserialport ***
    _QtModuleDef(
        "QtSerialPort", shared_lib="SerialPort", translations=["qtserialport"]
    ),
    # *** qt/qtscript ***
    ...
    _QtModuleDef(
        None, shared_lib="SerialBus", plugins=["canbus"], bindings=["!PySide6"]
    ),
    _QtModuleDef(
        "QtSerialBus", shared_lib="SerialBus", plugins=["canbus"], bindings=["PySide6"]
    ),
    # *** qt/qtsvg ***
    _QtModuleDef("QtSvg", shared_lib="Svg"),
    # Qt6-only Qt module.
    _QtModuleDef(
        "QtSvgWidgets", shared_lib="SvgWidgets", bindings=["PySide6", "PyQt6"]
    ),
    # *** qt/qtspeech ***
    ...
    _QtModuleDef(
        None, shared_lib="Designer", plugins=["designer"], bindings=["PySide2"]
    ),
    _QtModuleDef(
        "QtDesigner",
        shared_lib="Designer",
    ...
    _QtModuleDef(
        "QtWebEngineCore", shared_lib="WebEngineCore", translations=["qtwebengine"]
    ),
    # QtWebEngineQuick is Qt6-only module (replacement for QtWebEngine in Qt5).
    _QtModuleDef(
        "QtWebEngineQuick", shared_lib="WebEngineQuick", bindings=["PySide6", "PyQt6"]
    ),
    ...
    _QtModuleDef(
        "QtPdfWidgets", shared_lib="PdfWidgets", bindings=["PySide6", "PyQt6"]
    ),
    # *** qt/qtwebsockets ***
    _QtModuleDef(
        "QtWebSockets", shared_lib="WebSockets", translations=["qtwebsockets"]
    ),
    # *** qt/qtwebview ***
    # No python module; shared library -> plugins association entry.
